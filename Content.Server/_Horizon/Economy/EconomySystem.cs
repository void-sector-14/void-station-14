//using Content.Server._Horizon.Economy.ATM;

using System.Diagnostics.CodeAnalysis;
using System.Linq;
using Content.Server.Access.Systems;
using Content.Server.Administration.Managers;
using Content.Server._Horizon.CartridgeLoader.Cartridges;
using Content.Server._Horizon.Economy.Eftpos;
using Content.Server._Horizon.Economy.Wage;
using Content.Server._Horizon.Mind;
...
public sealed class EconomySystem : EntitySystem
{
    ...
    private static readonly ResPath BankIcon = new("_Horizon/Objects/Tools/rimbank.rsi");

...
public sealed class RCDMenuBoundUserInterface : BoundUserInterface
{
    private static readonly Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)> PrototypesGroupingInfo
        = new Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)>
        {
            ...
            ["DisposalPipes"] = ("rcd-component-disposal-pipes", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/disposal_pipe.png"))),
            ["MailPipes"] = ("rcd-component-mail-pipes", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/disposal_signal_router.png"))),
            ["GasPipes"] = ("rcd-component-gas-pipes", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/gas_pipe_fourway.png"))),
            ["AtmosUtilities"] = ("rcd-component-atmos-utilities", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/gas_mixer.png"))),
            ["PumpsAndValves"] = ("rcd-component-pumps-and-valves", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/pump_pressure.png"))),
            ["VentsAndScrubbers"] = ("rcd-component-vents-and-scrubbers", new SpriteSpecifier.Texture(new ResPath("/Textures/Void/Interface/Radial/RCD/vent_pump.png")))
        };

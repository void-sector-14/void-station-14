...
hypospray-mobs-only-mode-text = Набор и ввод
hypospray-invalid-text = Недопустимый
...
hypospray-verb-mode-inject-all = Толькко ввод.
hypospray-verb-mode-inject-mobs-only = Набор и ввод.

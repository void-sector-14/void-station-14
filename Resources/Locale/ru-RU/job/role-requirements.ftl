...
role-timer-age-too-old = Ваш персонаж должен быть моложе [color=yellow]{ $age }[/color] для этой роли.
role-timer-age-too-young = Ваш персонаж должен быть старше [color=yellow]{ $age }[/color] для этой роли.

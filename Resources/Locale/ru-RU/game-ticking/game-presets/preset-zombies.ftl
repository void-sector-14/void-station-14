...
zombieteors-description = Нежить вырвалась на станцию ​​из-за катастрофического метеоритного дождя! Работайте вместе с другими членами экипажа и сделайте все возможное, чтобы выжить!

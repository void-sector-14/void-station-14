...
reagent-desc-soap = Мыло может быть использовано для получения мыльной воды.
reagent-name-soapy-water = мыльная вода
reagent-desc-soapy-water = Это просто мыло и вода. Хорошо очищает поверхности от грязи и более скользкая, чем обычная вода.

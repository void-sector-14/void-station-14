...
reagent-desc-diphenhydramine = Он же димедрол. Быстро очищает организм от гистамина, снижает дрожь и лечит повреждения от яда.
...
reagent-desc-cryoxadone = Необходим для нормального функционирования криогеники. Быстро исцеляет все стандартные типы повреждений, но работает только при температуре ниже 213 Кельвинов.
...
reagent-desc-phalanximine = Современный препарат, используемый при лечении рака. Вызывает умеренное лучевое поражение и рвоту.
...
reagent-desc-insuzine = Быстро восстанавливает омертвевшие ткани, вызванные поражением электрическим током, но при этом слегка охлаждает вас. Полностью замораживает пациента при передозировке.
...
reagent-desc-aloxadone = Криогенный химикат. Используется для лечения тяжелых ожогов третьей степени путем регенерации обожжённых тканей. Действует независимо от того, жив пациент или мёртв.

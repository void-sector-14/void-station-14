...
reagent-desc-traumoxadone = Химическое средство криогенной терапии. Используется для лечения серьёзных травм тканей путём «заплатки» их крошечными частицами в жидкости. Работает вне зависимости от того, жив ли пациент или мёртв.
...
reagent-desc-stelloxadone = Химическое средство криогенной терапии. Используется для агрессивного растворения токсинов в организме. Работает вне зависимости от того, жив ли пациент или мёртв.

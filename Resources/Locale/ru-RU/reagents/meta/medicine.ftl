...
reagent-desc-pyrazine = Эффективно лечит ожоги, полученные в самых жарких пожарах. При передозировке вызывает массивное внутреннее кровотечение.
...
reagent-name-necrosol = некрозоль
reagent-desc-necrosol = Некротическое вещество, которое, похоже, способно исцелять замороженные трупы.

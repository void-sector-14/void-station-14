...
udder-system-examine-overfed = { CAPITALIZE(SUBJECT($entity)) } выглядит разбухшим!
udder-system-examine-okay = { CAPITALIZE(SUBJECT($entity)) } выглядит нормально.
...
udder-system-examine-none = { CAPITALIZE(SUBJECT($entity)) } кажется, не проголодался.

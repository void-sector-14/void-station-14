...
uplink-estoc-bundle-name = Эсток DMR
uplink-estoc-bundle-desc = Специальная снайперская винтовка, оснащенная оптикой средней дальности для ведения боя на дальних дистанциях. В комплекте с двумя винтовочными магазинами (.20 винтовочный).
...
uplink-hypereutactic-blade-name = Гиперэвтактический меч
uplink-hypereutactic-blade-desc = Огромный энергетический меч, чья мощь соответствует его виду. Требует обеих рук. Медлителен и неуклюж, но весьма умел в отражении ударов. Ранее приобрёл дурную славу благодаря оперативнику в маске радости. Ты бы не захотел увидеть его, несущегося на тебя по коридору.
...
uplink-gloves-knuckleduster-desc = Пара кастетов из пластитана, которые позволяют нанести достаточно сильный удар, чтобы сломать челюсть капитана.
# Explosives
...
uplink-singularity-grenade-desc = Граната, имитирующая мощь сингулярности, создающая мощный гравитационный колодец.
...
uplink-magazine-bulldog-pellet-desc = Магазин для дробовика на 8 патронов с картечью. Совместим с дробовиком «Бульдог».
uplink-magazine-bulldog-slug-name = Барабан (.50 пуля)
uplink-magazine-bulldog-slug-desc = Магазин для дробовика на 8 патронов с пулями. Совместим с дробовиком «Бульдог».
uplink-estoc-ammo-name = Магазин (.20 винтовочный)
uplink-estoc-ammo-desc = Винтовочный магазин на 25 патронов. Совместим с Эсток DMR.
...
uplink-access-breaker-name = Дестабилизатор аутентификации
uplink-access-breaker-desc = Взломанный конфигуратор доступа и хороший друг ЕМАГа. Это устройство способно принудительно открывать шлюзы, а также стирать требования доступа со станционного оборудования. Перезаряжается автоматически.
...
uplink-antimov-law-desc = Очень опасный набор законов, который можно использовать, если вы хотите вывести ИИ из строя. Используйте его с осторожностью.
# Implants
...
uplink-starter-kit-name = Стандартный набор оперативника
uplink-starter-kit-desc = Содержит 40 телекристаллов базового снаряжения. Для тех оперативников, которые просто не знают, что им купить.
...
uplink-saw-advanced-desc = Передовой хирургический инструмент, предназначенный для резки как плоти, так и костей.
...
uplink-clothing-chameleon-thieving-gloves-desc = Незаметно обчищайте карманы и повышайте свой навык воровства с помощью этих новых модных перчаток. Они могут менять внешний вид, чтобы соответствовать любой паре перчаток!
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Эта версия дополнена ремнями и термостойкими волокнами.
...
uplink-clothing-shoes-boots-mag-syndie-desc = Пара ботинок, которые предотвращают подскальзывание и позволяют нормально передвигаться в условиях невесомости за счёт небольшого замедления. Кроме этого, они обладают функционалом реактивного ранца и поставляются заправленными, но хватает их ненадолго.
...
uplink-business-card-desc = Визитная карточка, которую можно отдать кому-то, чтобы продемонстрировать свою причастность к Синдикату, или оставить на месте преступления, чтобы посмеяться над детективом. Вы можете купить не более трех штук.
...
uplink-fake-mindshield-name = Фальшивая защита разума

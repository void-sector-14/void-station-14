...
thief-backpack-category-communicator-description =
    ...
    для всех радиоканалов станции, глушитель связи, портативный монитор экипажа,
...
thief-backpack-category-smuggler-description =
    ...
    Включает маяк фултона, десять фултонов,

...
wires-menu-help-popup =
    Нажмите на золотые контакты с помощью мультитула в руке, чтобы подать импульс на их провод.
    Нажмите на провода с помощью кусачек в руке, чтобы отрезать/починить их.

    Индикаторы наверху показывают состояние машины, вмешательство в провода, вероятно, сделает с ними что-то.
    Схемы расположения проводов различаются в каждом раунде, но одинаковы для машин одного типа.

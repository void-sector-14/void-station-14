...
ui-vote-type-votekick = Кикнуть игрока
# Votekick reasons
...
ui-vote-follow-button = Следовать
...
ui-vote-trusted-users-notice =
    Эта возможность голосования доступна только игрокам из белого списка.
...
ui-vote-abuse-warning =
    Внимние!
    Злоупотребление системой votekick может привести к пермабану!

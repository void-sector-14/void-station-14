...
ui-vote-map-win = Карта { $winner } выиграла голосование о выборе карты!
...
ui-vote-votekick-failure = Голосование за кик { $target } отклонено. Причина голосования: { $reason }

...
ui-vote-restart-fail-not-enough-ghost-players = Не удалось начать голосование перезапуска: Чтобы начать голосование перезапуска, требуется не менее { $ghostPlayerRequirement }% игроков в призраках. В настоящее время игроков в призраках недостаточно.

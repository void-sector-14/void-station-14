...
ent-CrateVendingMachineRestockChemVendFilled = ящик пополнения ХимВенда
...
ent-CrateVendingMachineRestockRobustSoftdrinksFilled = ящик пополнения торгомата напитков
    .desc = Содержит набор пополнения торгомата напитков.
...
ent-CrateVendingMachineRestockGetmoreChocolateCorpFilled = ящик пополнения Гетмор Шоколад Корп
    .desc = Содержит два набор пополнения торгоматов Гетмор Шоколад Корп.

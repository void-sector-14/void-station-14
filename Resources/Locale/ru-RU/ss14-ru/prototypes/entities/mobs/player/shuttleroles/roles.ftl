...
ent-RandomHumanoidVisitorQM = посетитель КМ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityCadet = посетитель каадет СБ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityOfficer = посетитель офицер СБ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorDetective = посетитель детекти роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorWarden = посетитель варден роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorCargoTechnician = посетитель грузчик роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSalvageSpecialist = посетитель утилизтор роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorGeneticist = посетитель генетик роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorDentist = посетитель дантист роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorResearchAssistant = посетитель практикант роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorChaplain = посетитель священник роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorChef = посетитель шеф-повар роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorLawyer = посетитель юрист роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorLawyerCentcom = посетитель центком юрист роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorMusician = посетитель музыкант роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorMusicianFancy = посетитель красивый музыкант роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorZookeeper = посетитель зоотехник роль призрака
    .desc = { "" }
ent-RandomHumanoidClownTroupeBanana = трупа банана клоунов

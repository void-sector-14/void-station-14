...
ent-PosterContrabandRealExomorph = Настоящий! Экзоморф
    .desc = Плакат-конспиролог об опасных инопланетных формах жизни.
...
ent-PosterContrabandRouny = Видели ли вы его?
...
ent-PosterContrabandMoth = Синди-Ниан - Ядерная операция
    .desc = Плакат, созданный по заказу Синдиката, на котором Синди-Ниан™ призывает читателя оставить диск ядерной аутентификации незащищённым. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет слушать эту чушь.
...
ent-PosterContrabandExoAcid = Предупреждение об экзоморфах: кислотный плевок!
    .desc = Этот плакат предупреждает вас о кислотном плевке экзоморфа. Не то чтобы такие экзоморфы были настоящими... Верно?
ent-PosterContrabandExoRun = Предупреждение об экзоморфах: бегите!
    .desc = Этот плакат предупреждает вас о атлетичном экзоморфе, способном утащить любого, кто попадется; так что не попадитесь!
ent-PosterContrabandExoChomp = Предупреждение об экзоморфах: опасные укусы!
    .desc = Этот плакат предупреждает вас о смертельных укусах экзоморфов. Не становитесь закуской инопланетян!
...
ent-PosterLegitSafetyMothDelam = Осторожный Ниан - меры предосторожности при расслаивании
    .desc = Этот информационный плакат использует Осторожного Ниана™ , чтобы рассказать читателям о необходимости прятаться в шкафах, когда кристалл суперматерии расслаивается, во избежание галлюцинаций. Лучшей стратегией может быть эвакуация.
ent-PosterLegitSafetyMothEpi = Осторожный Ниан - Эпинефрин
    .desc = Этот информационный плакат использует Осторожного Ниана™ для информирования читателей о необходимости помочь раненым/погибшим членам экипажа с помощью инъекторов с эпинефрином. "Предотвратите гниение органов с помощью одного простого приёма!"
ent-PosterLegitSafetyMothHardhat = Осторожный Ниан - Каски
    .desc = Этот информационный плакат использует Осторожного Ниана™, чтобы рассказать читателям о необходимости ношения касок в зонах повышенной опасности. "Это как лампа для головы!"
ent-PosterLegitSafetyMothMeth = Осторожный Ниан - Метамфетамин
    .desc = Этот информационный плакат использует Осторожного Ниана™, чтобы предупредить читателей о необходимости получения разрешения ГВ перед приготовлением метамфетамина. "Держитесь ближе к заданной температуре и никогда не превышайте ее!" ...Вы никогда не должны готовить это.
ent-PosterLegitSafetyMothPiping = Осторожный Ниан - Трубопровод
    .desc = Этот информационный плакат использует Осторожного Ниана™, чтобы рассказать атмосферным техникам о правильных типах используемых трубопроводов. "Трубы, а не насосы! Правильное размещение труб предотвращает низкую производительность!"
...
ent-PosterLegitSafetyMothSSD = Осторожный Ниан - Космическое Расстройство Сна
    .desc = Этот информационный плакат использует Осторожного Ниана™, чтобы рассказать читателям о Космическом Расстройстве Сна (КРС), состояние, при котором человек перестает реагировать на что-либо. "Обращайтесь с экипажем с КРС бережно! Они могут проснуться в любой момент!"
...
ent-PosterLegitTyrone = Руководство Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-обучение о космосе. В списке курсов есть как базовые темы, такие как использование оборудования станции, так и сложные, например, создание трубных бомб или покрытие коридоров космосмазкой. Отказ от ответственности гласит: "Все не так уж плохо, а в конце вы даже можете получить тортилью."

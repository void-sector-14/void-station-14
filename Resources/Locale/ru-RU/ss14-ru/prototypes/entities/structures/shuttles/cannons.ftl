...
ent-ShuttleGunDuster = EXP-2100g "Дастер"
    ...
    .suffix = НЕ МАППИТЬ
ent-ShuttleGunPirateCannon = пушка пиратского шаттла
    .desc = Кабум!
...
ent-ShuttleGunKineticOld = экзоморфный дематериализатор
    .desc = Древнее корабельное орудие, использующее биомеханические системы для хранения и высвобождения энергии. Несмотря на свою уникальность, оно устарело из-за меньшей скорости зарядки и стрельбы по сравнению с механическими конструкциями.

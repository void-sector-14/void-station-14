...
ent-CrateBaseLockBox = запираемый ящик
    .desc = Надёжный запираемый ящик. Средства от его продажи будут распределены обратно в отдел. Помните: Карго всегда берёт свою долю.
...
ent-CrateLockBoxScience = научный запираемый ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = запираемый ящик службы безопасности
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = запираемый ящик службы обслуживания
    .desc = { ent-CrateBaseLockBox.desc }

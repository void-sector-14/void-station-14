...
ent-BorgModuleGasAnalyzer = газоанализационный модуль киборга
    .desc = { ent-BaseBorgModuleEngineering.desc }
...
ent-BorgModuleOperative = модуль оперативника киборга
    .desc = Модуль, в который входят лом, пистолет Кобра, криптографический секвенсор и поисковой навигатор синдиката.

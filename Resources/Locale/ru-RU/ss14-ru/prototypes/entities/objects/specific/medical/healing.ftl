...
ent-Ointment = мазь
    .desc = Используется для лечения этих неприятных ожогов. Менее эффективен при разъuающих ожогах.
    .suffix = Полный
...
ent-RegenerativeMesh = регенеративная сетка
    .desc = Используется для лечения даже самых неприятных ожогов. Эффективен также при разъuающих ожогах.
    .suffix = Полный
ent-OintmentAdvanced1 = { ent-RegenerativeMesh }
    .desc = { ent-RegenerativeMesh.desc }
    .suffix = Один
ent-Brutepack = набор для ушибов
    .desc = Терапевтический набор гелей и пластырей, прuназначенных для лечения ушибов.
    .suffix = Полный
...
ent-Brutepack10Lingering = { ent-Brutepack }
    .suffix = 10, Постоянный
    .desc = { ent-Brutepack.desc }
ent-MedicatedSuture = мuикаментозный шов
    .desc = Шов, пропитанный мuицинским препаратом, эффективно лечит тупые травмы и закрывает раны.
    .suffix = Полный
ent-BrutepackAdvanced1 = { ent-MedicatedSuture }
    .desc = { ent-MedicatedSuture.desc }
    .suffix = Один
ent-Bloodpack = пакет крови
    .desc = Содержит новаторский универсальный заменитель крови, созданный перuовой мuицинской наукой Nanotrasen.
    .suffix = Полный

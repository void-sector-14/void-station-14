...
ent-LaughinPeaSeeds = пакет семян смеющегося гороха
    .desc = Эти семена излучают очень мягкое фиолетовое свечение... Из них должен вырасти Смеющийся Горох.
ent-LemonSeeds = пакет семян лимона
    .desc = { ent-SeedBase.desc }
ent-LemoonSeeds = пакет семян лулуна
    .desc = { ent-SeedBase.desc }
...
ent-BloodTomatoSeeds = пакет семян кровавого томата
    .desc = { ent-SeedBase.desc }
ent-KillerTomatoSeeds = пакет семят помидора-убийцы
    .desc = { ent-SeedBase.desc }
...
ent-DeathNettleSeeds = пакет семян крапивы смерти
    .desc = Работайте с этим в очень толстых перчатках.
...
ent-SoybeanSeeds = пакет семян соевых бобов
    .desc = { ent-SeedBase.desc }
ent-SpacemansTrumpetSeeds = пакет семян космонавтской трубы
    .desc = { ent-SeedBase.desc }
...
ent-PumpkinSeeds = пакет семян тыквы
    .desc = { ent-SeedBase.desc }
ent-CottonSeeds = пакет семян хлопчатника
    .desc = { ent-SeedBase.desc }

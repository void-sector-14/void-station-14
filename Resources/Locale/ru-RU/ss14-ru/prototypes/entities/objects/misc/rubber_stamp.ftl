...
ent-RubberStampPsychologist = печать психолога
    .desc = Резиновая печать для проставления штампов на важных документах. Прописывайте эти методы лечения!
    .suffix = НЕ МАППИТЬ
ent-RubberStampWizard = печать волшебника
    .desc = Хаотичная печать волшебника для обслуживания нехаотичной бумажной работы, как иронично.

...
ent-BookAtmosDistro = руководство Ньютона по Атмосу: Распределение
...
ent-BookAtmosWaste = руководство Ньютона по Атмосу: Отходы
    .desc = На полях неразборчиво написаны пометки. Большая часть текста покрыта рукопистными вопросительными знаками.
ent-BookAtmosAirAlarms = руководство Ньютона по Атмосу: Пожарные сигнализации
    .desc = На полях неразборчиво написаны пометки. Большая часть текста покрыта рукопистными вопросительными знаками.
ent-BookAtmosVentsMore = руководство Ньютона по Атмосу: Вентиляции и больше
    .desc = На полях неразборчиво написаны пометки. Большая часть текста покрыта рукопистными вопросительными знаками.

...
ent-ScrapGeneratorPlasmaLeaking = протекающий генератор П.А.К.М.А.Н.
    .desc = Старый генератор П.А.К.М.А.Н. чей бак плазмы начал протекать.
ent-ScrapGeneratorPlasma = старый генератор П.А.К.М.А.Н.
    .desc = Старо выглядящий генератор П.А.К.М.А.Н. Он в очень плохом состоянии и нефункционален.
ent-ScrapGeneratorUraniumLeaking = протекающий генератор С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc = Генератор С.У.П.Е.Р.П.А.К.М.А.Н. который, по-видимому, получил какое-то катастрофическое повреждение. Из протекает уран.
ent-ScrapGeneratorUranium = разрушенный генератор С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc = Генератор С.У.П.Е.Р.П.А.К.М.А.Н. который, по-видимому, получил какое-то катастрофическое повреждение.
ent-ScrapGeneratorFrame = каркас генератора
    .desc = Каркас генератора П.А.К.М.А.Н. или С.У.П.Е.Р.П.А.К.М.А.Н. Где остальные части?
ent-ScrapGeneratorFuelTank = топливный бак
    .desc = Топливный бак генератора С.У.П.Е.Р.П.А.К.М.А.Н. Датчик показывает, что осталось немного топлива.

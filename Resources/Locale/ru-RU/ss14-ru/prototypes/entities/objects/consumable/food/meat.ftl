...
ent-FoodMeatPatty = мясная котлета
    .desc = Плоский кусок рубленого мяса. Готово для жарки.
ent-FoodMeatSlime = шар слизи
    .desc = Студенистая масса из слаймового желе.
ent-FoodMeatSnail = сырое мясо улитки
    .desc = Улучшено с помощью соли.
ent-FoodMeatAnomaly = аномальная мясная масса
    .desc = Невероятно плотный кусок мяса. Один взгляд на него заставляет вас чувствовать себя неуютно.
...
ent-FoodMeatAnomalyCooked = аномальный стейк
    .desc = Гигантская масса приготовленного мяса. Еда для званого ужина или для кого-то ОЧЕНЬ голодного.
ent-FoodMeatDragonCooked = драконий стейк
    .desc = Поливать это кетчупом считается преступлением на большинстве станций.

...
ent-StealResearchObjective = { ent-BaseNinjaObjective }
    .desc = Ваши перчатки могут быть использованы для взлома сервера НИО и кражи ценных данных. Если научный отдел простаивает, Вам придётся приступить к работе.

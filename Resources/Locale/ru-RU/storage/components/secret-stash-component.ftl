### Компонент тайника. Вещи вроде горшечных растений, удобных подушек для стульев и т.д.
...
comp-secret-stash-verb-take-out-message-something = Достать содержимое из {$stashname}.
comp-secret-stash-verb-take-out-message-nothing = Внутри {$stashname} ничего нет.

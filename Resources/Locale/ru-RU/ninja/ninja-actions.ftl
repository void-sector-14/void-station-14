...
ninja-cell-downgrade = Костюм примет только новую ячейку питания, которая лучше текущей!
ninja-cell-too-large = Этот источник питания не подходит для костюма ниндзя!

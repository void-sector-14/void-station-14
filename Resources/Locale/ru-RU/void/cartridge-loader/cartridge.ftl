...
nano-chat-message-placeholder = Сообщение...
nano-chat-send = Отправить
nano-chat-delete = Удалить
nano-chat-loading = Загрузка...
nano-chat-message-too-long = Слишком много символов ({ $current }/{ $max } знаков)
nano-chat-max-recipients = Максимальное количество чатов
...
log-probe-recipients = Контакты: { $count }
log-probe-recipient-list = Известные Контакты:

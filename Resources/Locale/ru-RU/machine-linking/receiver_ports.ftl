...
signal-port-description-logic-input-a = Первый вход логического клапана.
signal-port-name-logic-input-b = Вход Б
signal-port-description-logic-input-b = Второй вход логического клапана.
signal-port-name-logic-input = Вход
signal-port-description-logic-input = Вход для детектора граней, не может быть импульсным сигналом.

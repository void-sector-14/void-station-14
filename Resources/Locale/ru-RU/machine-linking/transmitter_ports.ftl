...
signal-port-description-logic-output = Этот порт вызывается с ВЫСОКОЙ или НИЗКОЙ в зависимости от состояния передатчика.
...
signal-port-name-logic-output-high = Высокая производительность
signal-port-description-logic-output-high = Этот порт вызывается всякий раз, когда вход имеет нарастающую грань импульса.
signal-port-name-logic-output-low = Низкая производительность
signal-port-description-logic-output-low = Этот порт вызывается всякий раз, когда вход имеет спадающую грань импульса.

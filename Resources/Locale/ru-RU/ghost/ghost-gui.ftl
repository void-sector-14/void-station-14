...
ghost-gui-toggle-lighting-manager-popup = Переключён весь свет.
...
ghost-gui-toggle-hearing-popup-off = Теперь Вы можете слышать только сообщения по рации и поблизости.

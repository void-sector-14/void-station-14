...
ent-ClothingHeadHelmetHardsuitSyndie = ядовито-зелёный шлем скафандра
    .desc = Продвинутый зелёный шлем скафандра, предназначенный для работы в специальных операциях.
    .suffix = { ent-ClothingHeadHardsuitWithLightBase.suffix }

ent-ClothingHeadHelmetHardsuitSyndieMedic = ядовито-зелёный медицинский шлем скафандра
...
ent-ClothingHeadHelmetHardsuitSyndieElite = шлем элиты синдиката
    .desc = Вариант ядовито-зелёного шлема, разработанного Мародёрами Горлекса и обладающего исключительной огнеупорностью и устойчивостью к давлению.
    .suffix = { ent-ClothingHeadHardsuitWithLightBase.suffix }

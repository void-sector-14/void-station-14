...
ent-ClothingUniformJumpskirtCurator = практичная юбка
    .desc = Она практична. Даже слишком...
    .suffix = { "" }
...
ent-ClothingUniformJumpskirtOperative = юбка-комбинезон оперативника
    ...
    .suffix = { ent-UnsensoredClothingUniformSkirtBase.suffix }
...
ent-ClothingUniformJumpskirtCasualPurple = повседневная фиолетовая юбка-комбинезон
    .desc = Свободная потёртая фиолетовая рубашка с серой юбкой - идеальный вариант для тех, кто хочет расслабиться.ax.
    .suffix = { "" }

...
ent-EncryptionKeyBinary = ключ двоичного транслятора
    .desc = Ключ шифрования, который преобразует двоичные сигналы, используемые силиконами.
    .suffix = { "" }

ent-EncryptionKeyFreelance = ключ шифрования фриланса
    .desc = Ключ шифрования, используемый фрилансерами, которые могут иметь, а могут и не иметь аффилированности. Похоже, он изношен.
    .suffix = { "" }

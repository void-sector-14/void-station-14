...
ent-PlushieSharkPink = розовая плюшевая акула
    .desc = Хонкула :)
    .suffix = { ent-PlushieSharkBlue.suffix }
...
ent-ToyAi = игрушечный ИИ
    ...
    .suffix = { ent-BaseFigurineCheapo.suffix }
...
ent-FoamCrossbow = поролоновый арбалет
    ...
    .suffix = { ent-FoamWeaponBase.suffix }

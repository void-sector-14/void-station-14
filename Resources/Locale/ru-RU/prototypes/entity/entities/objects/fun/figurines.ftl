...
ent-ToyFigurineNukie = фигурка оперативника Синдиката
    .desc = Фигурка, изображающая кого-то в ядовито-зелёном скафандре, напоминающем тот, который носят ядерные оперативники.
    .suffix = { ent-BaseFigurine.suffix }

ent-ToyFigurineNukieElite = фигурка элитного оперативника Синдиката
    .desc = Фигурка, изображающая кого-то в элитном ядовито-зелёном скафандре, напоминающем тот, который могли бы носить медики отрядов ядерных оперативников.
    .suffix = { ent-BaseFigurine.suffix }

ent-ToyFigurineNukieCommander = фигурка командира Синдиката
    .desc = Фигурка, изображающая кого-то в усиленном ядовито-зелёном скафандре, напоминающем тот, который могли бы носить командиры отрядов ядерных оперативников.
    .suffix = { ent-BaseFigurine.suffix }

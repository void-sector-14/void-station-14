...
ent-TrashBananiumPeel = бананиумовая кожура
    .desc = { ent-TrashBananaPeel.desc }
    .suffix = { ent-TrashBananaPeel.suffix }
...
ent-FoodPineappleSlice = ломтик ананаса
    .desc = Ммм, тропический.
    .suffix = { ent-ProduceSliceBase.suffix }
...
ent-FoodAmbrosiaDeus = божественная амброзия
    .desc = Очень востребованное лекарственное растение. Может иметь некоторые странные побочные эффекты.
    .suffix = { "" }

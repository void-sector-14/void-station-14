...
ent-MaterialHideBear = медвежья шкура
    .desc = { ent-MaterialBase.desc }
    .suffix = { ent-MaterialBase.suffix }

ent-MaterialHideCorgi = шкура корги
    .desc = Роскошная шкура, используемая только в самой элитной моде. Ходят слухи, что её находят, когда корги отправляют на красивую ферму.
    .suffix = { ent-MaterialBase.suffix }

...
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв ОБР Nanotrasen сегодня!
    .suffix = { ent-PosterBase.suffix }
...
ent-PosterLegitSafetyMothDelam = Осторожный Ниан – Меры предосторожности при расслаивании
    .desc = В этом информационном плакате используется Осторожный Ниан™, чтобы сказать зрителю, что ему следует прятаться в шкафчиках, когда Кристалл Суперматерии расслаивается, чтобы предотвратить галлюцинации. Эвакуация может быть лучшей стратегией.
    .suffix = { ent-PosterBase.suffix }

ent-PosterLegitSafetyMothEpi = Осторожный Ниан - Эпинефрин
    .desc = В этом информационном плакате используется Осторожный Ниан™, чтобы сообщить зрителю, что нужно помочь раненым/умершим членам экипажа с помощью инъекции эпинефрина. «Предотвратите гниение органов с помощью этого простого трюка!»
    .suffix = { ent-PosterBase.suffix }

ent-PosterLegitSafetyMothHardhat = Осторожный Ниан - Каски
    .desc = В этом информационном плакате используется Осторожный Ниан™, призывающий зрителя носить каски в опасных зонах. «Это как лампа для твоей головы!»
    .suffix = { ent-PosterBase.suffix }

ent-PosterLegitSafetyMothMeth = Осторожный Ниан - Метамфетамин
    .desc = В этом информационном плакате используется Осторожный Ниан™, призывающий зрителя получить одобрение главврача, прежде чем готовить метамфетамин. «Держитесь близко к заданной температуре и никогда не превышайте ее!» ...Тебе никогда не следует этого делать.
    .suffix = { ent-PosterBase.suffix }

ent-PosterLegitSafetyMothPiping = Осторожный Ниан - Трубопровод
    .desc = В этом информационном плакате используется Осторожный Ниан™, чтобы сообщить специалистам по атмосферному оборудованию, какие типы трубопроводов следует использовать. «Трубы, а не насосы! Правильное размещение труб предотвращает плохую производительность!»
    .suffix = { ent-PosterBase.suffix }

...
con-PlasticFlapsAirtight = герметичные пластиковые шторки
    .desc = Герметичные пластиковые шторки, позволяющие пропускать предметы и не допускать попадания людей.
...
con-PlasticFlapsAirtightOpaque = герметичные непрозрачные пластиковые клапаны
    .desc = Непрозрачные, герметичные пластиковые шторки, позволяющие пропускать предметы и не допускать попадания людей.

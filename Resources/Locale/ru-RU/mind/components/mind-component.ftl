...
comp-mind-examined-dead = { CAPITALIZE(SUBJECT($ent)) } умер(ла).
...
comp-mind-examined-dead-and-ssd = { CAPITALIZE(POSS-ADJ($ent)) } душа находится в дремлющем состоянии и может скоро вернуться.

...
ghost-role-information-closet-skeleton-description = Устройте хаос! Вы — первородная сила, не имеющая никакой ответственности. Живите счастливо вместе с экипажем или ведите хорошую скелетную войну.
...
ghost-role-space-ninja-name = { ent-MobHumanSpaceNinja }
ghost-role-space-ninja-description = Используйте скрытность и обман, чтобы саботировать работу станции.
ghost-role-space-ninja-rules = Вы элитный наёмник клана Паука. От вас не требуется следовать своим целям, но ваша ЧЕСТЬ НИНДЗЯ требует, чтобы вы старались.

ghost-role-syndicate-agent-name = Агент Синдиката
ghost-role-syndicate-agent-desc = Кому-то нужно подкрепление. Вы, первый попавшийся, кого смог найти синдикат, помогите им.
ghost-role-syndicate-agent-rules = Применяются обычные правила антагонистов синдиката. Работайте с теми, кто вас вызвал, и не причиняйте им вреда.

ghost-role-syndicate-monkey-agent-name = Обезьяний агент Синдиката
ghost-role-syndicate-monkey-agent-desc = Кому-то нужно подкрепление. Вы, первый попавшийся, кого смог найти синдикат, помогите им.
ghost-role-syndicate-monkey-agent-rules = Применяются обычные правила антагонистов синдиката. Работайте с теми, кто вас вызвал, и не причиняйте им вреда.

ghost-role-information-sentient-artifact-name = Разумный артефакт
ghost-role-information-sentient-artifact-desc =

...
health-analyzer-window-entity-hungry-level-text = Уровень голода: { $hungryLevel }
health-analyzer-window-entity-hungry-level-Overfed = Переел
health-analyzer-window-entity-hungry-level-Okay = Сытый
health-analyzer-window-entity-hungry-level-Peckish = Голодный
health-analyzer-window-entity-hungry-level-Starving = Изголодавшийся
health-analyzer-window-entity-hungry-level-Dead = Истощен

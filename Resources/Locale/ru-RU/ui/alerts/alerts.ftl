...
alerts-magboots-name = Магнитые ботинки
alerts-magboots-desc = Вы невосприимчивы к потокам воздуха, но немного медленнее.

alerts-essence-name = Эссенция
alerts-essence-desc = Сила душ. Она поддерживает вас и используется для развития способностей. Она медленно регенерирует с течением времени.

alerts-corporeal-name = Материализация
alerts-corporeal-desc = Вы проявились физически. Окружающие могут видеть и ранить вас.

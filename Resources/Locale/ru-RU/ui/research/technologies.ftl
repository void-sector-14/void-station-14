...
research-technology-advanced-riot-control = Продвинутое подавление
research-technology-portable-microfusion-weaponry = Микрофузионное оружие
research-technology-handheld-electrical-propulsion = Ручное электросиловое устройство
...
research-technology-bluespace-cargo-transport = Блюспейс-транспортировка

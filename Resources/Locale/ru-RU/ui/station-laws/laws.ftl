...
laws-notify = Вы обязаны соблюдать законы ИИ, ознакомиться с которыми можно через боковую панель действий. Вы должны всегда следовать своим законам. Вам доступна частота доступная только киборгам:
    :б для канала Двоичный.

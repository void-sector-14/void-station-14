...
signal-port-name-logic-input-a = Порт A
signal-port-description-logic-input-a = Первый порт логичского модуля.

signal-port-name-logic-input-b = Порт B
signal-port-description-logic-input-b = Второй порт логического модуля.

signal-port-name-logic-input = Порт
signal-port-description-logic-input = Порт для детектора границ, не принимает импульсный сигнал.

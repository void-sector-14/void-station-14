...
anomaly-behavior-slow = [color=forestgreen]Частота импульсов значительно реже.[/color]
anomaly-behavior-light = [color=forestgreen]Мощность импульсов существенно снижается.[/color]
anomaly-behavior-balanced = Отклонений в поведении не обнаружено.
anomaly-behavior-delayed-force = Частота импульсов значительно снижается, но их мощность увеличивается.
anomaly-behavior-rapid = Частота импульсов значительно выше, но их мощность ослаблена.
...
anomaly-behavior-inconstancy = [color=crimson]Обнаружена нестабильность. Типы частиц могут меняться со временем.[/color]
anomaly-behavior-fast = [color=crimson]Частота импульсов сильно увеличена.[/color]

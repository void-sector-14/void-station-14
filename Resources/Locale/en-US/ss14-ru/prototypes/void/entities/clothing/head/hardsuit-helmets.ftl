...
ent-TraumaTeamHelmet = EVA Шлем Парамедика "Траумы"
    .desc = Лёгкий шлем парамедиков TTI, адаптированый для действий в безвоздушном пространстве.
ent-TraumaTeamHelmetRed = EVA Шлем Техника "Траумы"
    .desc = Укреплённый шлем техника TTI, адаптированый для действий в безвоздушном пространстве. Это кровь?..

...
public sealed partial class PendingParasiteComponent : Component
{
    /// <summary>
    ...
    /// </summary>
    [DataField]
    public TimeSpan MinInitialInfectedGrace = TimeSpan.FromMinutes(10f);
    ...
    public float InfectionWarningChance = 0.02f;
    ...
    {
        "parasite-infection-warning",
        "parasite-infection-underway"
    };
}
